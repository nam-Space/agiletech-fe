        ...
        <div className="footer">
            ...
            <div className="footer-wrapper">
                <div className="footer-wrapper-1">
                    ...
                    <p className="location-2">Bahagia Ave Street PRBW 29281</p>
                    <p className="info-1">info@warehouse.project</p>
                    <p className="info-2">1-232-3434 (Main)</p>
                </div>
